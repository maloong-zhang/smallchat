...
import ae.zerotone.chat.domain.ClientMsgProtocol;
import ae.zerotone.chat.util.ChannelHandler;
import ae.zerotone.chat.util.MsgUtil;
    ...
    if (msg instanceof WebSocketFrame) {
      ...
      if (2 == clientMsgProtocol.getType()) {
        TextWebSocketFrame textWebSocketFrame =
            MsgUtil.buildMsgAll(ctx.channel().id().toString(), clientMsgProtocol.getMsgInfo());
